...
namespace HumanResources.EntityFramework.Migrations
{
    ...
    [Migration("20241012114411_AddressMovedToContactInformation")]
    partial class AddressMovedToContactInformation
    {
        /// <inheritdoc />
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("ContactInformation", "HumanResources.Entities.Employee.Person#Person.ContactInformation#ContactInformation", b2 =>
                                {
                                    ...
                                    b2.ComplexProperty<Dictionary<string, object>>("Address", "HumanResources.Entities.Employee.Person#Person.ContactInformation#ContactInformation.Address#Address", b3 =>
                                        {
                                            b3.IsRequired();
