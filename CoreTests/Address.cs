...
public class AddressTests
{
    ...
    {
        var address = Address.CreateBasic(street, city, state, zipCode);
    ...
    [InlineData("123 Main St", "Springfield", "IL", "627 as")]
    ...
    {
        Assert.Throws<ArgumentException>(() => Address.CreateBasic(street, city, state, zipCode));
    }
}